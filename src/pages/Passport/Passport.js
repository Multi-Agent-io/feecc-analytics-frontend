        ...
        <div className={styles.passportHeaderWrapper}>
          ...
          <div className={styles.passportNameWrapper}>
            ...
            <div className={styles.icons}>
              <img
                className={clsx({ [styles.inactiveIcon]: !passport.overwork })}
                src={overworkIcon}
                alt="Overwork icon"
              />
              <img
                className={clsx({ [styles.inactiveIcon]: !passport.needFix })}
                src={fixRequiredIcon}
                alt="Fix required icon"
              />
            </div>
          </div>
          ...
          <div className={styles.modalWrapper}>
            <div className={styles.modalContent}>
              ...
              {selectedStep.video_hashes !== null ? (
                ...
                <div className={styles.cantFindVideo}>
