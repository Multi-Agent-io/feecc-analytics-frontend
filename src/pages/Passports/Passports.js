...
import {getAuthorizationStatus, getFiltersValues, getPassports, getPassportsNumber} from "../../store/selectors";
import {history} from "../../store/main";
import {dropStoredFilters} from "../../store/filtersActions";
...
export default function Passports(props) {
    ...
    let [filtersValues, setFiltersValues] = useState(useSelector(getFiltersValues))
