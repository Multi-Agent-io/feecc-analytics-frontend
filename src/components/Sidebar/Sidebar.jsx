...
export default function Sidebar() {
  ...
  const changeLocation = (path) => history.push(path);
  const logout = () => {
    localStorage.clear();
    history.push('/');
  };
  return (
    <aside className={styles.columnWrapper}>
      ...
      <div className={styles.menu}>
        <div
          className={clsx(styles.menuItem, { [styles.selectedItem]: pathname === '/passports' })}
        ...
        <div
          className={clsx(styles.menuItem, { [styles.selectedItem]: pathname === '/tcd' })}
        ...
        <div
          className={clsx(styles.menuItem, { [styles.selectedItem]: pathname === '/employees' })}
        ...
        <div
          className={clsx(styles.menuItem, { [styles.selectedItem]: pathname === '/production-schemas' })}
